...
*  [8.5 工具条详解  258](#8.5)
## [9.数据存储于传输](#9)
*  [9.1 Ext.data命名空间下常用组件简介 276](#9.1)
*  [9.2 Ext.data.Connection 276](#9.2)
*  [9.3 Ext.data.Record 277](#9.3)
*  [9.4 Ext.data.Store 278](#9.4)
*  [9.5 常用Proxy 285](#9.5)
*  [9.6 常用Reader 287](#9.6)
*  [9.7 高级store 291](#9.7)
*  [9.8 Ext中的Ajax 292](#9.8)
*  [9.9 关于scope和bind()解决this问题 293](#9.9)
## [10.用户拓展与插件](#10)
## [11.拖放](#11)
## [12.实用工具](#12)
*  [12.1 Ext提供的常用函数](#12.1)
*  [12.2 使用DomHelper和Template动态生成HTML 352](#12.2)
*  [12.3 图形报表 361 类似echart](#12.3)
*  [12.4 悬停提示 371](#12.4)
*  [12.5 使用Ext.Utils.CSS切换主题 374](#12.5)
*  [12.6 使用fx实现动画效果 376](#12.6)
## [13.实例完整的ext应用 379](#13)
## [14.应用MVC 406](#14)
*  [14.1 详细目录 376](#14.1)
...
* XmlReader,
  ...
  <h2 id='12'> 使用工具 342</h2>
  
  <h4 id='12.1'> Ext提供的常用函数 </h4>
  
  * onReady() 函数；  页面解析后，才可以操作HTML中的dom内容;onReady()提供这个时机；
  * get(), 获取ext元素，Ext.Element的对象， getCmp()函数 获得Ext组件； getDom() 获取文档中的dom节点； getBody()函数==document.body;
  * encode() decode(); 专门用来对json数据进行编码和解码函数；  encode()将对象，数组或其他值编码，转换成json字符串形式； "http://url.com?json="+encodeURIComponent(Ext.encode(obj));
  * extend(); 
  * apply() applyIf()
  * namespace()
  
  <h4 id='12.2'> 使用DomHelper和Template动态生成HTML 352 </h4>

  使用dom原生的API动态生成HTML是一件很令人头疼的事情，ext中几乎所有组件都是动态生成的，现在我们就来看看Ext是如何动态生成HTML的。

  <h4 id='12.3'> 图形报表 361 类似echart </h4>

  <h4 id='12.4'>悬停提示 371 </h4>
  
  <h4 id='12.5'> 使用Ext.Utils.CSS切换主题 374</h4>
  
  <h4 id='12.6'> 使用fx实现动画效果 376</h4>

  <h2 id='13'> 一个完整的Ext应用 379</h2>

  1. 确定整体布局，2. 使用HTML和CSS设置静态信息， 3.对学生信息进行数据建模 4.在页面中显示学生信息列表  5.添加表单编辑学生信息 6 为表单添加提交事件
  7. 清空表单信息  8. 删除指定的学生信息  9. 在表格和表单之间进行数据交互  10. 提升加载速度
  
  整体功能自己项目基本用到过，不做细致的笔记

  <h2 id='14'> 应用MVC 406</h2>
  
  详细介绍了Ext中引入MVC的概念以及应用方法，结合一个实际的复杂示例演示了mvc如何影响开发过程。 mvc通过模块的方式实现了业务逻辑与数据展示的分离， 最直接的体现就是数据、展示、逻辑控制被显示地分隔到不同文件中。
  不会大块的视图展示部分与处理业务逻辑代码混在一起，方便代码封装和复用。结构清晰，提升代码的可读性和维护性。

  <h4 id='14.1'> 详细目录 426</h4>
